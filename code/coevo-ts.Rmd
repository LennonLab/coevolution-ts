...
First let's look at decomposition of a single sample (WSO-L1), looking at total cells (log-transformed before decomposition, for better plotting)
...
AIC(cell.rm.AR1,cell.rm.ARMA )%>%arrange(AIC)
# 
...
The differences in models was not great, so let's look also at the AR1 model:  
```{r, message = FALSE, warning = FALSE}
