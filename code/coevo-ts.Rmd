...
d%>%
  filter(Time>=0)%>%
  #add columns on phage and seed bank treatments as encoded in culture name
...
The decompisition removes the bi-daily fluctuations (season component) and reveals 2 population cycles in the first week, followed by a steady rise in the second week.
...
The patterns are somewhat clearer. Especially obvious is the differences between WT (long and short seed bank) and SPOIIE (no seed bank) in the frst week when infected with phage. The 3 lines with the non-sporulating mutant all have simmilar looking cycles. 
