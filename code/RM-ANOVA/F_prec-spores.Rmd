...
The data does fulfills the assumption of equal variance across test groups, at a borderline p-value.
...
The results lead to simmilar conclusions across the models, with the exeption of phage X seed-bank interaction which hovers around the .05 significance threshold.
