...
ggplot(aes(x=Time, y = m))+
  ...
  ggsave(here("plots","pop-dynamics.png"),p, width = 7, height = 4, bg = "white")
...
ggplot(aes(x=Time, y = m))+
  ...
  ylab("Abundance (per mL)")+
  xlab("Time (day)") ->p
  ggsave(here("plots","pop-dynamics-bg.png"),p, width = 7, height = 4, bg = "white")
