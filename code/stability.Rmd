...
cell.stab.win <- 
  ...
  group_by(flask)%>%
  #stability = mean / SD (over time)
  summarise(Time=roll_mean(Time,win.size,fill=NA ),
            t.mean=roll_mean(cell.ml,win.size,fill=NA ),
            t.sd=roll_sd(cell.ml,win.size,fill=NA ),
